...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[60vh] bg-gradient-hero flex items-center justify-center overflow-hidden">
      ...
      {/* Main content */}
      <div className="relative z-10 container mx-auto px-4 md:px-6 text-center pt-4 md:pt-0">
